...
INSERT INTO "new_Post" ("date_created", "id", "text", "title", "userCreatedId", "userUpdatedId", "visibility") SELECT "date_created", "id", "text", "title", "userCreatedId", "userUpdatedId", "visibility" FROM "Post";
DROP TABLE "Post";
